...
$c_Lexample_ScalaJSExample$.prototype.main__V = (function() {
  var paragraph = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("p");
  paragraph.innerHTML = "<strong>It works!</strong>";
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("playground").appendChild(paragraph)
});
...
$m_Lexample_ScalaJSExample$().main__V();
}).call(this);
